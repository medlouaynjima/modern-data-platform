...
3. `silver_transformation` — Spark batch job writing typed Silver Delta tables
4. `wait_for_spark_thrift` — wait for Spark Thrift Server before dbt
5. `dbt_gold_build` — run `dbt build` for Gold analytics marts
